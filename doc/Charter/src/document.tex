...
\newcommand*{\SignatureAndDate}[1]{%
    \par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.5in]{\hrulefill} \hfill\makebox[1in]{\hrulefill}%
}%
...
\par\noindent\makebox[2.5in][c]{\textbf{Parent/Guardian Signature}}      \hfill\makebox[2.5in][c]{\textbf{Student Name (Printed)}} \hfill\makebox[1in][c]{\textbf{Date}}%
\SignatureAndDate{}
\SignatureAndDate{}
\SignatureAndDate{}
\SignatureAndDate{}
